...
AGENT_DEPLOYMENT_METHOD_AWS = 2
AGENT_DEPLOYMENT_METHOD_GCP = 3
AGENT_DEPLOYMENT_METHOD_AZURE = 4
AGENT_DEPLOYMENT_METHOD_DO = 5

DESTRUCTION_RULE_KEEP_FOREVER = '1'
DESTRUCTION_RULE_MAX_JOBS = '2'
DESTRUCTION_RULE_IDLE_TIME = '3'
